...
\subsection{Lenguaje de Programación Backend: PHP 8.4}
Utilizamos la versión más moderna y optimizada del lenguaje PHP, permitiéndonos aprovechar las últimas mejoras del motor de ejecución (JIT), tipado estricto en los parámetros y retornos de métodos, y una mayor velocidad de procesamiento.
